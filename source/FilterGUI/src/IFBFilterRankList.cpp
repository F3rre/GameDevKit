#include "IFBFilterRankList.h"
#include <ctime>
#include <windows.h>
#include <shellapi.h>
#define ELECTUSTITLES_APPLY_BUTTON 19
#define ELECTUSTITLES_SELECTEDTITLE 18
#define ELECTUSTITLES_SELECTEDTITLE_LABEL 17
#define ELECTUSTITLES_VSCROLL 16
#define ELECTUSTITLES_TEXTBOX 15
#define ELECTUSTITLES_TOOLTIP 14
#define ELECTUSTITLES_REFRESH_BUTTON 13
#define ELECTUSTITLES_CLOSE_BUTTON 12
#define ELECTUSTITLES_TITLE 11
#define ELECTUSTITLES_FRAME 10
...
bool CIFCustomRankList::OnCreate(long ln)
{
   // printf("> " __FUNCTION__ "(%d)\n", ln);
    ...
    m_custom_label2 = (CIFStatic*)CGWnd::CreateInstance(this, GFX_RUNTIME_CLASS(CIFStatic), stratcherect, GDR_BFILTER_STREACH, 0);
    ...
    line1->m_custom_label2->TB_Func_13("interface\\ifcommon\\bfilter\\honorpoints_rank1.ddj", 0, 0);
    line2->m_custom_label2->TB_Func_13("interface\\ifcommon\\bfilter\\honorpoints_rank2.ddj", 0, 0);
    line3->m_custom_label2->TB_Func_13("interface\\ifcommon\\bfilter\\honorpoints_rank3.ddj", 0, 0);
    line4->m_custom_label2->TB_Func_13("interface\\ifcommon\\bfilter\\honorpoints_rank4.ddj", 0, 0);
    line5->m_custom_label2->TB_Func_13("interface\\ifcommon\\bfilter\\honorpoints_rank5.ddj", 0, 0);
