...
bool CIFCustomRankList::OnCreate(long ln)
{
   // printf("> " __FUNCTION__ "(%d)\n", ln);
    ...
    line1->m_custom_label2->TB_Func_13("interface\\ifcommon\\filter\\honorpoints_rank1.ddj", 0, 0);
    line2->m_custom_label2->TB_Func_13("interface\\ifcommon\\filter\\honorpoints_rank2.ddj", 0, 0);
    line3->m_custom_label2->TB_Func_13("interface\\ifcommon\\filter\\honorpoints_rank3.ddj", 0, 0);
    line4->m_custom_label2->TB_Func_13("interface\\ifcommon\\filter\\honorpoints_rank4.ddj", 0, 0);
    line5->m_custom_label2->TB_Func_13("interface\\ifcommon\\filter\\honorpoints_rank5.ddj", 0, 0);
