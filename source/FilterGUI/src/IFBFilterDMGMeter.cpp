...
void CIFDMGMeter::On_BtnClick()
{

}

void CIFDMGMeter::On_BtnClick1()
{
}

void CIFDMGMeter::OnClick_Exit()
{
    this->OnCloseWnd();
}

void CIFDMGMeter::WriteLine(BYTE Num, const wchar_t* Charname, const wchar_t* DMG)
{
    switch (Num)
    {
    case 1:
