...
GFX_IMPLEMENT_DYNCREATE(CIFSurvCounter, CIFMainFrame)
GFX_BEGIN_MESSAGE_MAP(CIFSurvCounter, CIFMainFrame)
GFX_END_MESSAGE_MAP()


CIFSurvCounter::CIFSurvCounter(void)
{
   // printf("> " __FUNCTION__ "\n");
}
...
bool CIFSurvCounter::OnCreate(long ln)
{
   // printf("> " __FUNCTION__ "(%d)\n", ln);
    ...
    m_title->SetText(L"Survival Kills");
...
void CIFSurvCounter::OnUpdate()
{
}

void CIFSurvCounter::On_BtnClick()
{

}

void CIFSurvCounter::On_BtnClick1()
{
}

void CIFSurvCounter::OnClick_Exit()
{
    this->OnCloseWnd();
}

void CIFSurvCounter::ResetPosition()
{
...
void CIFSurvCounter::WriteLine(BYTE Num, const wchar_t* Charname, const wchar_t* DMG)
{
    switch (Num)
    {
    case 1:
