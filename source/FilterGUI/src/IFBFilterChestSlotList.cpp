...
//void CIFPlayerChestSlotList::WriteLine(BYTE num, const wchar_t* UQName, const wchar_t* State, const wchar_t* Killer, const wchar_t* STme)
//{
//	CIFPlayerChestSlot* Line = m_IRM.GetResObj<CIFPlayerChestSlot>(num, 1);
//
