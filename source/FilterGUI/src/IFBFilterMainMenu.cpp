...
GFX_END_MESSAGE_MAP()
 ...
 CIFSpinControl* CIFMainMenu::SpinControlGUI;
 CIFGMPassword* CIFMainMenu::GMPasswordGUI;
...
void CIFMainMenu::On_BtnClick_1()
{
	...
	CIFMainMenu::ChestGUI->ShowGWnd(true);
...
{
	LAB_TITLES->SetText(L"Title Storage TR");
	LAB_TITLES1->SetText(L"Grant Name TR");
	LAB_TITLES2->SetText(L"Unique History TR");
	LAB_TITLES3->SetText(L"Character Lock TR");
	LAB_TITLES4->SetText(L"Custom Rank TR");
	LAB_TITLES5->SetText(L"Event Schedule TR");
}
